...
router.get('/',authentication_mdl.is_login, function (req, res) {
 ...
 req.getConnection(function(err,connection)
		{
                    var query = connection.query('SELECT * FROM foodstore_category order by cat_id desc', function(err,rows)
				{
                                    if(err)
						{
...
router.post('/insert_product/', multer({ storage : storage }).single('userPic'), function(req,res,next){
	     ...
	     if(!errors)
            {
                ...
                console.log(filename);
                 gm('./public/uploads/cat_image/'+filename)
                     .resize(100, 100)
                      .gravity("Center")
                       .extent(100, 100)
                        .quality(75)
...
//    gm('./public/cat_image/' + file.originalname)
//    .resize(100, 100)
//    .gravity("Center")
//    .extent(100, 100)
//    .quality(75)
//    .noProfile()
//    .write('./public/cat_image/thumb/' + file.originalname, function (err) {
